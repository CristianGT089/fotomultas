...
\institute{%
    ...
    \textbf{Director:} Julio Barón Velandia, PhD
}
...
\begin{frame}[plain,noframenumbering]
    ...
    \begin{center}
        ...
        {\small
        \textbf{Director:} Julio Barón Velandia, PhD \hspace{2em} \textbf{Jurado:} Roberto Pava Díaz, PhD}
    \end{center}
    \vfill
\end{frame}
...
\input{slides/00_contexto}

% Sección 3: Objetivos (después de mostrar cómo se resolvió)
\input{slides/01_objetivos}

% Sección 1: Metodología
\input{slides/02_metodologia}

% Sección 2: Resultados
\input{slides/03_resultados}

% Sección 3: Demostración del prototipo
\input{slides/03b_demostracion}

% Sección 4: Conclusiones
\input{slides/04_conclusiones}

% Sección 5: Trabajo futuro
\input{slides/05_trabajo_futuro}
