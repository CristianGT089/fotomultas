...
\begin{frame}{Plan de Pruebas: Cobertura Integral}
...
\begin{frame}{Pruebas de Inmutabilidad: Núcleo del Sistema}
...
% ==================== SLIDE 20: INTERFACES ====================
\begin{frame}{Prototipo Funcional: Interfaces Desarrolladas}
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \centering
