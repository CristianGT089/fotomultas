...
\begin{frame}[shrink=5]{Plan de Pruebas: Cobertura Integral}
    ...
    \footnotesize
    Nota: Pruebas automatizadas del backend.
...
\begin{frame}[shrink=5]{Pruebas de Inmutabilidad: Núcleo del Sistema}
    ...
    \footnotesize
    Nota: Casos de prueba de inmutabilidad.
...
\begin{frame}[shrink=5]{Métricas de Desempeño}
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \textit{Comparación FÉNIX vs Prototipo}
            ...
            \footnotesize
            Nota: Comparativa modelo centralizado vs distribuido.
        \end{column}
    \end{columns}
...
\begin{frame}[shrink=5]{Cumplimiento de Objetivos}
    ...
    \footnotesize
    Nota: Verificación de objetivos del proyecto.
...
\begin{frame}[shrink=15]{Prototipo Funcional: Interfaces Desarrolladas}
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \footnotesize
            Nota: Interfaz web del prototipo.
