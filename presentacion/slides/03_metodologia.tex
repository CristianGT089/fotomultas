...
\begin{frame}{Arquitectura Híbrida: Decisión Crítica}
...
\begin{frame}{Arquitectura Híbrida del Sistema}
    \begin{center}
        \includegraphics[height=0.7\textheight]{images/Despliegue.png}
    \end{center}
...
\begin{frame}{Diseño Orientado a Objetos}
    \begin{columns}[T]
...
\begin{frame}{Diagramas de Actividad: Procesos Críticos}
    \begin{columns}[T]
