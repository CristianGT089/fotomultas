...
\section{Metodología y Diseño del Prototipo}
...
\begin{frame}[shrink=10]{Arquitectura Híbrida: Decisión Crítica}
    ...
    \footnotesize
    Nota: Arquitectura del sistema propuesto.
...
\begin{frame}[shrink=10]{Diseño Orientado a Objetos}
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            ...
            \footnotesize
            Nota: Diseño arquitectónico del prototipo.
        \end{column}
...
\begin{frame}[shrink=15]{Diagramas de Actividad: Procesos Críticos}
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \textit{Creación de Multa}

            \includegraphics[width=0.9\textwidth]{images/ActMulta.png}

            \footnotesize
            Nota: Flujo de registro implementado.
        ...
        \begin{column}{0.5\textwidth}
            ...
            \footnotesize
            Nota: Proceso de apelación implementado.
