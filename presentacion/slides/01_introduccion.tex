...
\begin{frame}[shrink=5]{Escala Operativa del Sistema de Fotocomparendos en Bogotá}
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \vspace{0.5em}
            \begin{itemize}
                \item \highlight{1.9 millones} de comparendos emitidos (2018-2024) (Secretaría Distrital de Movilidad (SDM), 2024)
...
\begin{frame}[shrink=5]{Crisis de Confianza: Indicadores Críticos}
    ...
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            \begin{itemize}
                \item \textbf{Tasa de impugnación:} \highlight{34.1\%} (Contraloría de Bogotá, 2023)
                    \begin{itemize}
                        \item 1 de cada 3 comparendos genera disputa formal
                    \end{itemize}
                \item \textbf{Carga operativa:} \highlight{155,854 PQRSD} semestrales (Contraloría de Bogotá, 2023)
                \item \textbf{Detrimento patrimonial:} \highlight{\$8,000 millones} (hallazgos auditoría) (Contraloría de Bogotá, 2023)
