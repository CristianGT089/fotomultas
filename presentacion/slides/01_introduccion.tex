...
\sectionframe{Contexto y Problemática}

% ==================== SLIDE 3: MAGNITUD DEL PROBLEMA ====================
\begin{frame}{Escala Operativa del Sistema de Fotocomparendos en Bogotá}
    \begin{columns}[T]
...
\begin{frame}{Crisis de Confianza: Indicadores Críticos}
