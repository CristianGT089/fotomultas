a% ==================== SECCIÓN 2: JUSTIFICACIÓN Y OBJETIVOS ====================
...
\begin{frame}[shrink=10]{Estado del Arte: Posicionamiento Científico}
    \scriptsize
    \textbf{Tabla 2}
    \textit{Estado del arte: posicionamiento científico}
    \begin{table}
        \centering
    ...
    \textbf{Nota.} Elaboración propia basada en revisión bibliográfica.
...
\begin{frame}[shrink=5]{Relevancia Científica del Tema}
    ...
    \begin{columns}[T]
        \begin{column}{0.33\textwidth}
            ...
            \textit{Producción científica mundial}

            \includegraphics[width=\textwidth]{images/MapaBibliometrix.png}

            Nota. Elaboración propia basada en Scopus (2024).
        \end{column}
        \begin{column}{0.33\textwidth}
            \centering
            Figura 3

            \textit{Evolución temporal}
        ...
        \begin{column}{0.33\textwidth}
            ...
            \textbf{Nota.} Elaboración propia basada en Scopus (2024).
        \end{column}
    \end{columns}
