...
\begin{frame}{Arquitectura híbrida: decisión de diseño}
    ...
    \footnotesize
    \begin{table}
        \caption{Componentes de la arquitectura híbrida}
        \centering
...
\begin{frame}{Actores y funcionalidades principales}
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            ...
            \captionof{figure}{\textit{Diagrama de casos de uso}}
        \end{column}
...
\begin{frame}{Flujos de proceso: diagramas de actividades}
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \captionof{figure}{\textit{Registro de multa}}
        \end{column}
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[height=0.65\textheight]{images/ActApelacion.png}
            \captionof{figure}{\textit{Proceso de apelación}}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Arquitectura del sistema}
    \begin{center}
        ...
        \captionof{figure}{\textit{Diagrama de despliegue del sistema}}
    \end{center}
