\begin{longtable}{p{2.5cm} p{3.8cm} p{3.8cm} p{4.0cm}}
    \caption{Comparación entre un modelo centralizado y un modelo descentralizado} \\
        \toprule
        \textbf{Característica} & \textbf{Modelo Centralizado} & \textbf{Modelo Descentralizado} & \shortstack{Relevancia Contextual\\(Auditoría No. 90)} \\
        \midrule
        \endfirsthead
