...
\begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 8. Diagrama de casos de uso del sistema de gestión de infracciones de tránsito}
    \centering
...
\begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 9. Diagrama de despliegue de la arquitectura del sistema}
    \centering
...
Hay que considerar que se manejarán dos capas de lógica: la primera enfocada en registrar los cambios en los estados de las multas a través de blockchain y la segunda capa encargada de la administración general de las multas (manipular los datos que no son visibles al público). 
 \begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 10. Diagrama de clases del sistema de gestión de multas}
    \centering
...
En la Figura \ref{fig:diagrama_clases} se hace un esquema de la primera capa lógica que se encarga de la administración general de las multas y los datos que maneja
 \begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 11. Diagrama de actividades para el proceso de apelación de multa}
    \centering
...
\subsection{ Diagrama de actividades }
 \begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 12. Diagrama de actividades para el proceso de creación de multa}
    \centering
...
\paragraph{Compartidas}
 \begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 13. Pantalla de login del sistema}
    \centering
...
En la Figura~\ref{fig:login} se aprecia la pantalla de inicio de sesión, punto de entrada para todos los usuarios autorizados del sistema.
 ...
 \begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 14. Pantalla de recuperación de contraseña}
    \centering
...
\begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 15. Dashboard del agente de tránsito}
    \centering
...
En la Figura~\ref{fig:dashboard_agente} se presenta el tablero principal que resume las métricas de gestión de multas para el agente de tránsito.
 \begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 16. Pantalla de consulta del estado de multa}
    \centering
...
La Figura~\ref{fig:consulta_estado_multa} ilustra la consulta rápida del estado de una multa, facilitando el seguimiento por parte del agente.
 \begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 17. Pantalla de consulta de detalle de multa}
    \centering
    \includegraphics[width=0.8\textwidth]{Images/UI4.png}
    \vspace{2em}
    \begin{flushleft}
...
En la Figura~\ref{fig:consulta_detalle_multa} se muestra el detalle completo de una multa específica, incluida la evidencia asociada.
 ...
 \begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 18. Pantalla de consulta de multas para propietarios de vehículos}
    \centering
