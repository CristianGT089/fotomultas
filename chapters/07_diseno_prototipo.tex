...
\begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 9. Diagrama de actividades para el proceso de creación de multa}
    \centering
...
En la Figura \ref{fig:diagrama_creacion_multa} se muestra el flujo completo para el registro de una nueva infracción, desde la captura de evidencia hasta la sincronización en ambas blockchains. El proceso inicia con la validación de datos del vehículo en el RUNT, continúa con el almacenamiento de evidencia en IPFS privado, registro en Hyperledger Fabric y finalmente la publicación de metadatos en Ethereum para consulta pública.
...
\begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 10. Diagrama de actividades para el proceso de apelación de multa}
    \centering
...
\begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 11. Diagrama de despliegue de la arquitectura del sistema}
    \centering
...
\paragraph{Compartidas}
 \begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 12. Pantalla de login del sistema}
    \centering
...
En la Figura~\ref{fig:login} se aprecia la pantalla de inicio de sesión, punto de entrada para todos los usuarios autorizados del sistema.
 ...
 \begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 13. Pantalla de recuperación de contraseña}
    \centering
...
\begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 14. Dashboard del agente de tránsito}
    \centering
...
En la Figura~\ref{fig:dashboard_agente} se presenta el tablero principal que resume las métricas de gestión de multas para el agente de tránsito.
 \begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 15. Pantalla de consulta del estado de multa}
    \centering
...
La Figura~\ref{fig:consulta_estado_multa} ilustra la consulta rápida del estado de una multa, facilitando el seguimiento por parte del agente.
 \begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 16. Pantalla de consulta de detalle de multa}
    \centering
    \includegraphics[width=0.8\textwidth]{Images/UI4.png}
    \vspace{2em}
    \begin{flushleft}
...
En la Figura~\ref{fig:consulta_detalle_multa} se muestra el detalle completo de una multa específica, incluida la evidencia asociada.
 ...
 \begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 17. Pantalla de consulta de multas para propietarios de vehículos}
    \centering
...
\begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 18. Pantalla de detalle de multa para propietarios de vehículos}
    \centering
