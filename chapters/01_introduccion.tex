...
Las tecnologías de registro distribuido, particularmente \textit{blockchain}, han demostrado ser efectivas para garantizar la inmutabilidad y verificabilidad de la información en contextos donde la seguridad jurídica y la transparencia son fundamentales, como la gestión gubernamental de datos y el tratamiento de evidencias digitales \parencite{C112_2018, gamero2020procedimiento}. A través de contratos inteligentes, es posible automatizar reglas de negocio y procesos de validación, reduciendo la intervención discrecional de los operadores humanos y mitigando riesgos de corrupción y errores administrativos asociados a la gestión de información sancionatoria \parencite{semana2023juzto}.
