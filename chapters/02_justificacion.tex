...
\begin{itemize}
    ...
    \item \textbf{Gobernanza automatizada:} Contratos inteligentes ejecutan las reglas de tránsito de manera predecible, eliminando la discrecionalidad administrativa que ha derivado en un detrimento patrimonial estimado en más de \$8.000 millones.

    \item \textbf{Almacenamiento descentralizado:} IPFS garantiza que las evidencias fotográficas sean inalterables y accesibles sin intermediarios, abordando las vulnerabilidades de confidencialidad identificadas en auditorías de la Contraloría.
\end{itemize}
