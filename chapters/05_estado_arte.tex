...
\begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 5. Distribución global de la producción científica sobre blockchain y gestión de infracciones}
    \centering
...
\begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 6. Evolución anual de publicaciones en los países líderes del tema (Brasil, México, Colombia, España y Perú)}
    \centering
...
\begin{figure}[htbp]
    ...
    \end{flushleft}
    \vspace{1em}
    \addcontentsline{lof}{figure}{Figura 7. Nube de palabras de los términos más recurrentes en la literatura sobre blockchain e infracciones}
    \centering
