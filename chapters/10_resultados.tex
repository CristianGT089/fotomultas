...
Como se observa en la Tabla~\ref{tab:validacion_estados}, el prototipo valida exitosamente los cinco estados implementados (PENDING, PAID, APPEALED, RESOLVED\_APPEAL, CANCELLED), que representan las transiciones críticas del ciclo de vida de un comparendo. Cada transición de estado fue probada mediante casos de prueba específicos que verifican:
...
\begin{longtable}{p{4cm}p{4cm}cp{4cm}}
