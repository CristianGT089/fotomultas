...
La arquitectura híbrida blockchain que combine Hyperledger Fabric (privacidad) y Ethereum (transparencia pública) es técnicamente viable para la gestión de fotocomparendos. El prototipo desarrollado valida que las tecnologías de registro distribuido pueden garantizar simultáneamente la inmutabilidad de registros, la protección de datos sensibles y la verificación pública ciudadana, abordando las limitaciones identificadas en el sistema actual de Bogotá.
