...
\subsection{Blockchain en gestión gubernamental}
...
\subsection{Integración blockchain-IPFS}
...
\subsection{Cadena de custodia digital}
...
\subsection{Casos de implementación gubernamental}
...
\begin{itemize}
	\item La tecnología blockchain coordina procesos complejos con múltiples partes interesadas, garantizando un registro único y verificable, con ahorros documentados de \textasciitilde{}100 millones de euros anuales en el caso sueco.
...
\subsection{Aplicaciones en tránsito}
...
\paragraph{Lecciones aprendidas} La principal lección aprendida de áreas adyacentes es la importancia de abordar no solo los desafíos técnicos \parencite{zheng2018blockchain} sino también los regulatorios, de gobernanza y de adopción \parencite{tan2022blockchain}. La ausencia de soluciones integrales reportadas para el flujo completo de gestión de fotocomparendos representa una brecha significativa, particularmente en contextos donde la ciudadanía carece de mecanismos para verificar independientemente la validez de las sanciones impuestas.
...
\subsection{Relevancia del prototipo}
...
\subsubsection{La relevancia del prototipo se justifica por su potencial para:}
\begin{itemize}
	...
	\item Reducir disputas y costos asociados a la gestión manual y a la falta de confianza en la evidencia, factores que en sistemas centralizados generan cargas operativas significativas.

	\item Explorar un modelo innovador de pago automatizado condicional basado en la verificación en blockchain.
\end{itemize}
\subsection{Tendencias internacionales}
...
\begin{figure}[htbp]
	...
	\vspace{2em}
	\begin{flushleft}
		\textit{Nota.} Mapa mundial y gráfico de líneas mostrando la producción científica sobre blockchain por países.
	\end{flushleft}
...
\begin{figure}[htbp]
	...
	\vspace{2em}
	\begin{flushleft}
		\textit{Nota.} Evolución anual de publicaciones científicas sobre blockchain en los países líderes.
	\end{flushleft}
...
\begin{figure}[htbp]
	...
	\vspace{2em}
	\begin{flushleft}
		\textit{Nota.} Nube de palabras con los términos más recurrentes en la literatura sobre blockchain e infracciones.
	\end{flushleft}
...
\begin{figure}[htbp]
	...
	\vspace{2em}
	\begin{flushleft}
		\textit{Nota.} Mapa temático de los principales temas de investigación en blockchain y gestión de infracciones.
	\end{flushleft}
	\refstepcounter{figure}\label{fig:mapa_tematico}
\end{figure}

\paragraph{Mapa temático}
El mapa temático representa la distribución de los principales temas de investigación en el área, organizados según su grado de desarrollo (densidad) y relevancia (centralidad). En el cuadrante superior derecho se ubican los ``temas motores'', como \textit{challenges}, \textit{framework}, \textit{model}, que son altamente desarrollados y centrales en la literatura.

En el cuadrante inferior derecho, los ``temas básicos'' como \textit{management}, \textit{secure}, \textit{network} e \textit{internet}, \textit{architecture}, \textit{things} son fundamentales pero menos desarrollados. El cuadrante superior izquierdo agrupa ``temas nicho'' como \textit{system}, \textit{encryption}, \textit{IoT} y \textit{design}, \textit{impact}, \textit{traceability}, que presentan alta especialización pero menor centralidad.

Finalmente, en el cuadrante inferior izquierdo se encuentran los ``temas emergentes o en declive'', como \textit{blockchain} y \textit{optimization}, \textit{technology}, que muestran baja densidad y centralidad, indicando áreas de reciente aparición o menor desarrollo. Esta visualización permite identificar las tendencias, vacíos y oportunidades de investigación en el campo.

% --- Fin de figuras Bibliometrix ---

\subsection{Sistema de fotocomparendo en Bogotá}
...
\subsubsection{Funcionamiento de los fotocomparendos en Bogotá: mecanismos, regulación e impacto}
...
\paragraph{Marco legal y regulatorio}

La implementación de fotocomparendos en Bogotá se sustenta en la Ley 1843 de 2017 \parencite{ley1843} y su reglamentación mediante resoluciones como la Resolución 20203040011245 \parencite{resolucion11245}. Estos instrumentos establecen cuatro criterios para instalar cámaras:
...
\myparagraph{Detección y captura de infracciones}
...
\myparagraph{Validación y notificación}
...
\myparagraph{Tecnología y transparencia}
...
\myparagraph{Problemas operativos identificados}
...
\myparagraph{Cuestionamientos legales}
...
\subsubsection{Análisis crítico del sistema FÉNIX: limitaciones estructurales identificadas}
...
\paragraph{Incumplimientos normativos en contratación}
...
\paragraph{Brechas en protección de datos personales}
...
\paragraph{Déficits en habilitación y capacidad técnica}
...
\paragraph{Síntesis de la problemática}
...
Esta problemática contextualiza la necesidad del prototipo propuesto en este trabajo, el cual busca demostrar cómo una arquitectura descentralizada puede mitigar estos riesgos mediante garantías técnicas intrínsecas de inmutabilidad, trazabilidad y verificabilidad.