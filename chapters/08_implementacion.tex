...
La implementación del prototipo se llevó a cabo siguiendo la arquitectura híbrida blockchain diseñada en la sección Diseño del prototipo, integrando Hyperledger Fabric para la gestión privada de datos sensibles, Ethereum para la transparencia pública y IPFS dual para el almacenamiento distribuido de evidencias.
...
Para la implementación de la capa privada (justificada en la sección Metodología), se utilizó Hyperledger Fabric con las siguientes tecnologías:
