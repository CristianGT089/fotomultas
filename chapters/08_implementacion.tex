...
Para la implementación de la capa pública (justificada en el Capítulo 5: Metodología), se utilizó el ecosistema de Ethereum con las siguientes tecnologías:
...
Para la implementación de la capa privada (justificada en el Capítulo 5: Metodología), se utilizó Hyperledger Fabric con las siguientes tecnologías:
...
La arquitectura de la capa pública se describe en detalle en el Capítulo 7: Diseño del Prototipo. Esta sección se enfoca en los aspectos específicos de implementación técnica.
...
La arquitectura de la capa privada y su justificación técnica se detallan en el Capítulo 5: Metodología y el Capítulo 7: Diseño del Prototipo. Esta sección describe la configuración técnica específica implementada.
...
La validación del prototipo se realizó siguiendo el plan de pruebas detallado en el Capítulo 9. La implementación incluyó la configuración de frameworks de testing en tres niveles:
...
Los resultados detallados de todas las pruebas ejecutadas, incluyendo cobertura de código, casos de prueba específicos y métricas de rendimiento, se presentan en el Capítulo 10: Resultados de las Pruebas.
